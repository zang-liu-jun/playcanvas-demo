...
class OrbitCamera {
    ...
    constructor(cameraNode: Entity, transitionTime: number, distance: number) {
        this.cameraNode = cameraNode;
        this.distance = distance;
        this.focalPoint = new SmoothedValue(new Vec3(0, 0, 0), transitionTime);
        // this.azimElevDistance = new SmoothedValue(new Vec3(0, 0, 3), transitionTime);
        this.azimElevDistance = new SmoothedValue(new Vec3(0, 0, 1).mulScalar(this.distance), transitionTime);
    }
    ...
    reposition() {
        this.focalPoint.goto(new Vec3(0, 0, 0));
        // this.azimElevDistance.goto(new Vec3(0, 0, 3));
        this.azimElevDistance.goto(new Vec3(0, 0, 1).mulScalar(this.distance));
    }
}
...
class OrbitCameraInputMouse {
    ...
    constructor(app: AppBase, orbitCamera: OrbitCamera) {
        this.app = app;
...
export { OrbitCamera, OrbitCameraInputMouse, OrbitCameraInputTouch };
